...
follower INTEGER,
followed INTEGER,
FOREIGN KEY (follower) REFERENCES nerd(nerd_id) ON DELETE CASCADE,
FOREIGN KEY (followed) REFERENCES nerd(nerd_id) ON DELETE CASCADE,
...
FOREIGN KEY (creatoreGruppo) REFERENCES nerd(nerd_id) ON DELETE SET NULL,
...
idIscritto INTEGER,
idGruppo INTEGER,
FOREIGN KEY (idIscritto) REFERENCES nerd(nerd_id) ON DELETE CASCADE,
FOREIGN KEY (idGruppo) REFERENCES gruppo(gruppo_id) ON DELETE CASCADE,
